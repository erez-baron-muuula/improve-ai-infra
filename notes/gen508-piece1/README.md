...
| File | What it is |
|------|-----------|
| `design-scoping-v3.md` | **Read this second, after the ticket.** The rebuilt scoping layer, converged through three `/check` rounds. Supersedes five sections of `design-converged.md`. |
...
| `design-converged.md` | The earlier converged design. Still governs everything `design-scoping-v3.md` does not supersede. |

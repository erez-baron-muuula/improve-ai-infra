...
22 of 27 still need fixing. The redesign shrinks the layer and removes 4, which is a real
reduction but not the bulk of the work — most of these are defects in the scoping layer, which
survives.

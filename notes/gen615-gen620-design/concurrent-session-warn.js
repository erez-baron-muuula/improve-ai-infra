...
function liveSessions() {
  ...
  try {
    ...
    return { ok: false, reason: 'registry-unreadable', sessions: sessions, seen: seen };
  }
  let parsed = 0;
  ...
  if (parsed === 0) {
    return { ok: false, reason: 'no-parsable-session-files', sessions: sessions, seen: seen };
  }
  return { ok: true, reason: null, sessions: sessions, seen: seen };
}

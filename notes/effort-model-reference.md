...
**Fable 5.1  >  Fable 5  ?  Opus 5.5  >  Opus 5  >  Opus 4.8  >  Sonnet 5  >  Haiku 4.5**

(Fable 5.1 and Opus 5.5 added 2026-09-24. Within-family order is by version; the cross-family position of Opus 5.5 relative to Fable 5 / Fable 5.1 is **unverified** — no sourced comparison yet. This has no effect on the floor test below, which is membership at-or-above Opus 4.8.)
